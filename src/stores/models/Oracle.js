...
export default class Oracle {
  ...
  constructor(oracle, app) {
    ...
    this.isUpcoming = this.phase === RESULT_SETTING && oracle.status === OracleStatus.WAIT_RESULT && (app.wallet.addresses.filter((addr) => (addr.address === this.resultSetterQAddress)).length === 0);
