...
const EnLang = {
  messages: {
    ...
    'oracle.resultsetnote': 'BOT tokens are needed for result setting. Don\'t leavethis screen upon clicking Confirm. Your BOT needs to be approved before result setting. The approved amount will automatically be used to set the result after approval.',
    ...
    'oracle.votenote': 'BOT tokens are needed for voting. Don\'t leave this screen upon clicking Confirm. Your BOT needs to be approved before voting. The approved amount will automatically be used to vote afterwards.',
    'oracle.passvote': 'Current block time has passed the Voting End Time. The previous result needs to be finalized in order to withdraw.',
    'oracle.finalize': 'Finalizing can be done by anyone. Once finalized, winners can withdraw from the event in the Withdraw tab.',
