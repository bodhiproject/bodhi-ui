...
const HTTP_ROUTE = `${process.env.PROTOCOL_HTTP ? process.env.PROTOCOL_HTTP : 'https'}://${HOSTNAME}:${PORT}`;
const WS_ROUTE = `${process.env.PROTOCOL_WS ? process.env.PROTOCOL_WS : 'wss'}://${HOSTNAME}:${PORT}/graphql`;
