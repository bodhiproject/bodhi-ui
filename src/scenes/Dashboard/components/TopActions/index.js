          ...
          <Card className={classes.dashboardActionsSort}>
            <FormControl>
              <Select disableUnderline value={this.state.sortOption} onChange={this.onSortOptionSelected}>
                <MenuItem value={SortBy.Ascending}><FormattedMessage id="sort.ascEndTime" defaultMessage="Ascending" /></MenuItem>
                <MenuItem value={SortBy.Descending}><FormattedMessage id="sort.descEndTime" defaultMessage="Descending" /></MenuItem>
              </Select>
            </FormControl>
          </Card>
        </Grid>
