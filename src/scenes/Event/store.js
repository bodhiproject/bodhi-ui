...
export default class EventStore {
  ...
  @observable address = INIT.address // Current Oracle contract address.
  @observable topicAddress = INIT.topicAddress //  Topic contract address.
  @observable transactions = INIT.transactions // Transactions for this Event.
  ...
  @observable buttonDisabled = INIT.buttonDisabled // Disabled if
  ...
  @computed get unconfirmed() { // For Oracle only
