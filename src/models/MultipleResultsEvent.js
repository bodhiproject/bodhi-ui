...
export default class MultipleResultsEvent {
  ...
  blockNum = 0 // Block number when the event was created
  ...
  version = 0 // Current version of the contract
  name = '' // Name
  results = [] // Results
  numOfResults = 0 // Number of results
  ...
  escrowAmount = 0 // Escrow amount deposited in decimals
  ...
  currentRound = 0 // Current round of Oracle
  currentResultIndex = 0 // Current winning result index
  consensusThreshold = 0 // Current consensus threshold for the round in decimals
  arbitrationEndTime = '' // Timestamp of the end of the arbitration round
  totalBets = 0 // Total amount of all bets in decimals
