            ...
            <div>
              <div className="topbarWrapper">
                ...
                <ul className="isoRight">
                  <li><Link to="/" ><FormattedMessage id="topBar.events" defaultMessage="Events" /></Link></li>
                  <li><Link to="/create-topic" ><FormattedMessage id="topBar.create" defaultMessage="Create an Event" /></Link></li>
                  <li>{walletAddrsEle}</li>
                  <li><Button onClick={this.props.handler}><FormattedMessage id="language.select" defaultMessage="中文" /></Button></li>
                </ul>
              </div>
            </div>
          </div>
